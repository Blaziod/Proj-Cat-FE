            ...
            <BrowserRouter>
              ...
              <div className="app">
                <Routes>
                  ...
                  <Route
                    path={constants.routes.proposeTopic}
                    element={<ProposeTopic />}
                  />
                  <Route
                    path={constants.routes.studentLogin}
                    element={<Login />}
                  />
                  <Route
                    path={constants.routes.studentRegister}
                    element={<Register />}
                  />
                  <Route
                    path={constants.routes.lecturerRegister}
                    element={<LecturerRegister />}
                  />
                  <Route
                    path={constants.routes.lecturerLogin}
                    element={<LecturerLogin />}
                  />
                  <Route
                    path={constants.routes.lecturerDash}
                    element={<LecturerDashboard />}
                  />
                  <Route
                    path={constants.routes.studentDash}
                    element={<StudentDashboard />}
                  />
                  <Route
                    path={constants.routes.studentUpload}
                    element={<StudentUpload />}
                  />
                  <Route
                    path={constants.routes.projectUpload}
